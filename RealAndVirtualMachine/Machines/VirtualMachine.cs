...
namespace RealAndVirtualMachine.Machines
{
    ...
    {
        #region VIRTUAL MACHINE CONSTRUCTORS
        ...
        //Program counter (PC) - virtual address
        public short PC
        {
            get { return m_pc; }
            set
        ...
        //Stack pointer (SP) - points to data segment
        public short SP
        {
            get { return m_sp; }
            private set
        ...
        //Data pointer (DP) - points to data segment
        public short DP
        {
            get { return m_dp; }
            private set
        ...
        //Check if program (file) line is not null or does not contain more than 4 symbols
        ...
        #region STACK
        //LDxy - Push value to stack top from data area
        ...
        //PTxy - Push value to data area from stack top
